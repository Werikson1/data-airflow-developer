...
with dag:
    ...
    job_tb_teste_developer_master = BigQueryExecuteQueryOperator(
        task_id='job_tb_teste_developer_master',
    ...
    dq_tb_teste_developer_master = DummyOperator(
        task_id='dq_tb_teste_developer_master'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_teste_developer_master

    job_tb_teste_developer_master >> dq_tb_teste_developer_master