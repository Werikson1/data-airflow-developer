...
with dag:
    ...
    job_tb_airflow_devops1 = BigQueryExecuteQueryOperator(
        task_id='job_tb_airflow_devops1',
    ...
    dq_tb_airflow_devops1 = DummyOperator(
        task_id='dq_tb_airflow_devops1'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_airflow_devops1

    job_tb_airflow_devops1 >> dq_tb_airflow_devops1