...
with dag:
    ...
    job_tb_real_dia_cupom10 = BigQueryInsertJobOperator(
        task_id='job_tb_real_dia_cupom10',
        configuration={
            'query': {
    ...
    dqe_tb_real_dia_cupom10 = DummyOperator(
        task_id='dqe_tb_real_dia_cupom10'
    )
    
    sensor_tb_loja_venda_so >> dqv_tb_loja_venda_so >> job_tb_real_dia_cupom10

    job_tb_real_dia_cupom10 >> dqe_tb_real_dia_cupom10