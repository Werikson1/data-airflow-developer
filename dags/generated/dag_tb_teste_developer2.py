...
with dag:
    ...
    job_tb_teste_developer2 = BigQueryExecuteQueryOperator(
        task_id='job_tb_teste_developer2',
    ...
    dq_tb_teste_developer2 = DummyOperator(
        task_id='dq_tb_teste_developer2'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_teste_developer2

    job_tb_teste_developer2 >> dq_tb_teste_developer2