...
with dag:
    ...
    job_tb_teste_developer = BigQueryExecuteQueryOperator(
        task_id='job_tb_teste_developer',
    ...
    dq_tb_teste_developer = DummyOperator(
        task_id='dq_tb_teste_developer'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_teste_developer

    job_tb_teste_developer >> dq_tb_teste_developer