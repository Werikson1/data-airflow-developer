...
with dag:
    ...
    job_tb_real_dia_cupom1 = BigQueryExecuteQueryOperator(
    ...
    dq_tb_real_dia_cupom1 = DummyOperator(
        task_id='dq_tb_real_dia_cupom1'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_real_dia_cupom1

    job_tb_real_dia_cupom1 >> dq_tb_real_dia_cupom1