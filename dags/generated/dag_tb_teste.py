...
with dag:
    ...
    job_tb_teste = BigQueryExecuteQueryOperator(
        task_id='job_tb_teste',
    ...
    dq_tb_teste = DummyOperator(
        task_id='dq_tb_teste'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_teste

    job_tb_teste >> dq_tb_teste