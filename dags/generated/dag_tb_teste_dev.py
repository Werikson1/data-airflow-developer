...
with dag:
    ...
    job_tb_teste_dev = BigQueryExecuteQueryOperator(
        task_id='job_tb_teste_dev',
    ...
    dq_tb_teste_dev = DummyOperator(
        task_id='dq_tb_teste_dev'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_teste_dev

    job_tb_teste_dev >> dq_tb_teste_dev