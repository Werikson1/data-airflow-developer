...
with dag:
    ...
    job_tb_real_dia_cupomdsd = BigQueryExecuteQueryOperator(
        task_id='job_tb_real_dia_cupomdsd',
    ...
    dq_tb_real_dia_cupomdsd = DummyOperator(
        task_id='dq_tb_real_dia_cupomdsd'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_real_dia_cupomdsd

    job_tb_real_dia_cupomdsd >> dq_tb_real_dia_cupomdsd