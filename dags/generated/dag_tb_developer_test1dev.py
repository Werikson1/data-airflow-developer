...
with dag:
    ...
    job_tb_developer_test1dev = BigQueryExecuteQueryOperator(
        task_id='job_tb_developer_test1dev',
    ...
    dq_tb_developer_test1dev = DummyOperator(
        task_id='dq_tb_developer_test1dev'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_developer_test1dev

    job_tb_developer_test1dev >> dq_tb_developer_test1dev