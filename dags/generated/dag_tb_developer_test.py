...
with dag:
    ...
    job_tb_developer_test = BigQueryExecuteQueryOperator(
        task_id='job_tb_developer_test',
    ...
    dq_tb_developer_test = DummyOperator(
        task_id='dq_tb_developer_test'
    )
    
    sensor_tb_loja_venda_so >> dq_tb_loja_venda_so >> job_tb_developer_test

    job_tb_developer_test >> dq_tb_developer_test